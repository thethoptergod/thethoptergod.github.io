...
import picture from "../images/BulleitBourbon.jpg";
export default function BBFW(props){
    ...
    return (
        <>
            <h3>Bulleit Bourbon Frontier Whiskey</h3>
            ...
            ` ,maxWidth:"100%", gridArea: "rev"}}>
                <div className="revText" style={{gridArea: "text"}}>
                    Bulleit, distilled in Kentucky like most bourbons, is about the most average whiskey I've ever had. Nothing stand out, but also nothing offensive, a good whiskey for cocktails.
                </div>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
            <img onClick={() => {setVisible(!visible); setButton(!button)}} src={url} id="map" alt='Bulleit 3900 Benson Pike, Shelbyville, KY 40065 lat: 38.222983 long: -85.137184' style={{display: 'block'}}></img>
            </div>
            </div>
            </div>
        </>
