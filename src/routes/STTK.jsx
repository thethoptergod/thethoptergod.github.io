...
export default function STTK(props){
    ...
    return (
        <>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
            <img onClick={() => {setVisible(!visible); setButton(!button)}} src={url} id="map" alt='Yamazaki Distillery 5-2-1 Yamazaki, Shimamoto-cho, Mishima-gun, Osaka lat: 34.892574 long: 135.674487' style={{display: visible ? 'block' : 'none'}}></img>
            </div>
        </>
    )
}