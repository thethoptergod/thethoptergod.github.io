...
export default function JWDB(props){
    ...
    return (
        <>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
            <img onClick={() => {setVisible(!visible); setButton(!button)}} src={url} id="map" alt='Johnnie Walker 145 Princes St, Edinburgh EH2 4BL, United Kingdom lat: 55.95046630932092 long: -3.207577172596807' style={{display: visible ? 'block' : 'none'}}></img>
            </div>
        </>
    )
}