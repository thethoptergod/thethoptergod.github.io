...
export default function LSBT(props){
    ...
    return (
        <>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
            <img onClick={() => {setVisible(!visible); setButton(!button)}} src={url} id="map" alt='Heaven Hill Distillery 1311 Gilkey Run Rd, Bardstown, KY 40004' style={{display: visible ? 'block' : 'none'}}></img>
            </div>
        </>
    )
}